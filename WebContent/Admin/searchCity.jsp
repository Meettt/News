				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
						...
						<table class="table table-bordered table-striped mb-none"
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0"
										...
										style="width: 269px;">City-name</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
							...
							<m:forEach items="${sessionScope.cityls}" var="i">
								<tr>
									<td>${i.cityId}</td>
									<td>${i.cityName}</td>
									<td>${i.cityDes}</td>
									...
									<td class="actions">
										...
										<a href="<%=request.getContextPath()%>/City?cityId=${i.cityId}&string=edit" class="on-default edit-row"><i class="fa fa-pencil"></i></a> 
										<a href="<%=request.getContextPath()%>/City?cityId=${i.cityId}&string=delete" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
									</td>
								</tr>
							</m:forEach>
							</tbody>
