				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
						<section class="panel">
							...
							<m:forEach items="${sessionScope.topandlatestnewsls}" var="i">
								<tr>
									<td>${i.addNewsId}</td>
									<td>${i.headLine}</td>
									<td>${i.topNews}</td>
									...
									<td class="actions">
										...
										<a href="<%=request.getContextPath()%>/AddNews?addNewsId=${i.addNewsId}&string=edittopandlatest" class="on-default edit-row"><i class="fa fa-pencil"></i></a> 
									</td>
								</tr>
							</m:forEach>
							</tbody>
