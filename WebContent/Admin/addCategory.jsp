			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
						...
						<!-- Category -->
							<form  id="form" class="form-horizontal form-bordered" action="<%=request.getContextPath()%>/Category" method="post">
									<section class="panel">
										...
										<div class="panel-body">
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" name="categoryName" class="form-control" id="inputDefault" required aria-required="true"> 
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<textarea class="form-control" name="categoryDes" rows="3" id="textareaAutosize" data-plugin-textarea-autosize></textarea>
													</div>
												</div>
									...
									<a href="<%=request.getContextPath()%>/Category?string=search">
