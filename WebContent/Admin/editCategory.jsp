...
<html class="fixed">
	...
	<body>
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
						<div class="row">
							<div class="col-lg-12">
							<!-- Country -->
							<form id="form"  class="form-horizontal form-bordered" action="<%=request.getContextPath()%>/Category" method="get">
								<section class="panel">
									...
									<div class="panel-body">
										<m:forEach items="${sessionScope.categoryls}" var="i">
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="categoryName" value="${i.categoryName}"  class="form-control" id="inputDefault" required  aria-required="true">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaAutosize">Description</label>
												<div class="col-md-6">
													<textarea class="form-control" name="categoryDes" rows="3" placeholder=""  id="textareaAutosize" data-plugin-textarea-autosize>${i.categoryDes}</textarea>
												</div>
											</div>
											<input type="hidden" value="${i.categoryId }" name="categoryId">
		...
		<script src="js/examples.validation.js"></script>	<script src="js/autosize.js"></script>		<script src="js/bootstrap-fileupload.min.js"></script>
