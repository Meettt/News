									...
									<m:forEach items="${sessionScope.areals}" var="i">
											...
											<div class="col-md-6">
												<input type="text" name="areaName" class="form-control"
													value="${i.areaName}" id="inputDefault" required  aria-required="true">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-6">
												<textarea class="form-control" name="areaDes" rows="3"
													id="textareaAutosize" data-plugin-textarea-autosize>${i.areaDes}</textarea>
											</div>
										</div>
										<input type="hidden" value="${i.areaId}" name="areaId">
