						...
						<section class="panel">
							...
							<thead>
								<tr role="row">
									<th class="sorting_asc" tabindex="0"
										...
										aria-sort="ascending" style="width: 50px;">ID</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Browser: activate to sort column ascending"
										style="width: 269px;">Headline</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
										style="width: 243px;">Category</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
										style="width: 200px;">Sub-Category</th>
									
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Rendering engine: activate to sort column descending"
										aria-sort="ascending" style="width: 100px;">Area</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Browser: activate to sort column ascending"
									...
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
										style="width: 243px;">State</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
										style="width: 200px;">Country</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
										style="width: 150px;">Top-News</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
										style="width: 150px;">Latest-News</th>
									<th	rowspan="1" colspan="1"
										aria-label="Actions" style="width: 99px;">Date</th>
										<th	rowspan="1" colspan="1"
										aria-label="Actions" style="width: 99px;">Action</th>
								</tr>
							</thead>
							...
							<m:forEach items="${sessionScope.addnewsls}" var="i">
								<tr>
									...
									<td>${i.sub_categoryVO.sub_categoryName}</td>
									...
									<td class="actions">
										...
										<a href="<%=request.getContextPath()%>/AddNews?addNewsId=${i.addNewsId}&string=edit" class="on-default edit-row"><i class="fa fa-pencil"></i></a> 
										<a href="<%=request.getContextPath()%>/AddNews?addNewsId=${i.addNewsId}&string=delete" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
									</td>
								</tr>
							</m:forEach>
							</tbody>
