					...
					<div class="col-lg-12">
										...
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Response From Admin</h2>
											</header>
											<div class="panel-body">
												<div class="modal-wrapper">
													...
													<div class="modal-text">
														<h4>${param.complainName}</h4>
														<p>${param.complainResponse}</p>
													</div>
											...
											<footer class="panel-footer">
												<div class="row">
													...
													<a href="<%=request.getContextPath()%>/Complain?string=search&reporterId=1&flag=reporter" >	<button class="btn btn-primary">Back</button></a>
													</div>
												</div>
											</footer>
										</section>
