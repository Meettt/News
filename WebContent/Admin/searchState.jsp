							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0"
										...
										style="width: 269px;">State-name</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
							...
							<m:forEach items="${sessionScope.statels}" var="i">
								<tr>
									...
									<td class="actions">
										...
										<a href="<%=request.getContextPath()%>/State?stateId=${i.stateId}&string=edit" class="on-default edit-row"><i class="fa fa-pencil"></i></a> 
										<a href="<%=request.getContextPath()%>/State?stateId=${i.stateId}&string=delete" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
									</td>
								</tr>
							</m:forEach>
							</tbody>
