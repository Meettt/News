...
<html class="fixed">
	<head>
		...
		<title>Advanced Forms | Porto Admin - Responsive HTML5 Template 1.4.2</title>
	...
	<body>
						...
						<div class="row">
							<div class="col-xs-12">
								<section class="panel">
									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="<%=request.getContextPath()%>/extra">
											<div class="form-group">
												<label class="col-md-3 control-label">Summernote</label>
												<div class="col-md-9">
												<textarea name="text" class="summernote" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'>Start typing...</textarea>
		...
		<!-- Specific Page Vendor -->		<script src="js/jquery-ui.js"></script>	
