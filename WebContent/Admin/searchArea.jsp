							...
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<th class="sorting" tabindex="0"
										...
										style="width: 269px;">Area-name</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
									...
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
										style="width: 243px;">City</th>
									<th	rowspan="1" colspan="1"
										aria-label="Actions" style="width: 99px;">Actions</th>
								</tr>
										
									</thead>
									<m:forEach items="${sessionScope.areals}" var="i">
								<tr>
									<td>${i.areaId}</td>
									<td>${i.areaName}</td>
									<td>${i.areaDes}</td>
									...
									<td class="actions">
										...
										<a href="<%=request.getContextPath()%>/Area?areaId=${i.areaId}&string=edit" class="on-default edit-row"><i class="fa fa-pencil"></i></a> 
										<a href="<%=request.getContextPath()%>/Area?areaId=${i.areaId}&string=delete" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
									</td>
								</tr>
							</m:forEach>
					</table>
