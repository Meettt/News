							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0"
										...
										style="width: 269px;">First Name</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
										style="width: 243px;">Last Name</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
									...
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Browser: activate to sort column ascending"
										style="width: 200px;">Birth-Date</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
										style="width: 243px;">Phone-Number</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
							...
							<m:forEach items="${sessionScope.reporterls}" var="i">
								<tr>
									...
									<td class="actions">
										...
										<a href="<%=request.getContextPath()%>/Reporter?reporterId=${i.reporterId}&string=delete" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
									</td>
								</tr>
							</m:forEach>
							</tbody>
