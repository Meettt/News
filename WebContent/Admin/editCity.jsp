									...
									<m:forEach items="${sessionScope.cityls}" var="i">
											...
											<div class="col-md-6">
												<input type="text" name="cityName" class="form-control"
													value="${i.cityName}" id="inputDefault" required  aria-required="true">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label" for="textareaAutosize">Description</label>
											<div class="col-md-6">
												<textarea class="form-control" name="cityDes" rows="3"
													id="textareaAutosize" data-plugin-textarea-autosize>${i.cityDes}</textarea>
											</div>
										</div>
										<input type="hidden" value="${i.cityId}" name="cityId">
