			...
			<section role="main" class="content-body">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<!-- Sub-Categorey -->
						<form id="form" class="form-horizontal form-bordered"  method="post" action="<%=request.getContextPath()%>/Sub_category">
							...
							<section class="panel">
								...
								<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input type="text" name="sub_categoryName" class="form-control" id="inputDefault" required  aria-required="true">
											</div>
								...
								<footer class="panel-footer">
									...
									<a href="<%=request.getContextPath()%>/Sub_category?string=search">
