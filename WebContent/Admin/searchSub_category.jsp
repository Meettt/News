					...
					<!-- start: page -->
						<section class="panel">
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0"
										...
										style="width: 269px;">Sub_categoryName</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
							...
							<m:forEach items="${sessionScope.sub_categoryls}" var="i">
								<tr>
									<td>${i.sub_categoryId}</td>
									<td>${i.sub_categoryName}</td>
									<td>${i.sub_categoryDes}</td>
									<td>${i.categoryVO.categoryName}</td>

									<td class="actions">

										<a href="<%=request.getContextPath()%>/Sub_category?sub_categoryId=${i.sub_categoryId}&string=edit" class="on-default edit-row"><i class="fa fa-pencil"></i></a> 
										<a href="<%=request.getContextPath()%>/Sub_category?sub_categoryId=${i.sub_categoryId}&string=delete" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
									</td>
								</tr>
							</m:forEach>
							</tbody>
