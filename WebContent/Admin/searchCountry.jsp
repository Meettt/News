...
<title>Advanced Tables | Porto Admin - Responsive HTML5 Template
	1.4.2</title>
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0"
										...
										style="width: 269px;">Country-name</th>
									<th class="sorting" tabindex="0"
										aria-controls="datatable-editable" rowspan="1" colspan="1"
							...
							<m:forEach items="${sessionScope.countryls}" var="i">
								<tr>
									...
									<td class="actions">
										...
										<a href="<%=request.getContextPath()%>/Country?countryId=${i.countryId}&string=edit" class="on-default edit-row"><i class="fa fa-pencil"></i></a> 
										<a href="<%=request.getContextPath()%>/Country?countryId=${i.countryId}&string=delete" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
									</td>
								</tr>
							</m:forEach>
							</tbody>
