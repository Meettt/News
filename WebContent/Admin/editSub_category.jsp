				...
				<div class="row">
					<div class="col-lg-12">
						...
						<form id="form"  class="form-horizontal form-bordered" method="get"
							action="<%=request.getContextPath()%>/Sub_category">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Sub_category</h2>
								</header>
								<div class="panel-body">
								<m:forEach items="${sessionScope.sub_categoryls}" var="i">
									<!-- Search Country -->
									<div class="form-group">
										<label class="col-md-3 control-label" for="inputSuccess">Category</label>
										<div class="col-md-6">
											<select class="form-control mb-md" name="categoryId" >
												<m:forEach items="${sessionScope.categoryls}" var="m">
									...
									<div class="form-group">
										...
										<label class="col-md-3 control-label" for="inputDefault">Sub_categoryName</label>
										<div class="col-md-6">
											<input type="text" name="sub_categoryName" class="form-control"
												value="${i.sub_categoryName }" id="inputDefault" required  aria-required="true">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<textarea class="form-control" name="sub_categoryDes" rows="3"
												id="textareaAutosize" data-plugin-textarea-autosize>${i.sub_categoryDes}</textarea>
										</div>
									</div>
									<input type="hidden" value="${i.sub_categoryId }" name="sub_categoryId">
